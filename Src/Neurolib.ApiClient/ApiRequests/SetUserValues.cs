...
namespace Neurolib.ApiClient.ApiRequests
{
    ...
    /// <remarks>The properties (columns) must be previously created by Add user property(https://www.neurolib.io/pages/documentation/api.html#add-user-property).</remarks>
