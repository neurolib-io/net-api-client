...
namespace Neurolib.ApiClient.ApiRequests
{
    ...
    public class RecommendItemsToItem : Request
    {
        ...
        /// <summary>Boolean-returning [ReQL](https://www.neurolib.io/pages/documentation) expression which allows you to filter recommended items based on the values of their attributes.
        ...
        /// <summary>Number-returning [ReQL](https://www.neurolib.io/pages/documentation) expression which allows you to boost recommendation rate of some items based on the values of their attributes.
        ...
        /// ```
        /// </param>
        /// <param name="filter">Boolean-returning [ReQL](https://www.neurolib.io/pages/documentation) expression which allows you to filter recommended items based on the values of their attributes.
        /// Filters can be also assigned to a [scenario](https://www.neurolib.io/pages/documentation/scenarios.html) in the [Admin UI](https://admin.neurolib.io).
        /// </param>
        /// <param name="booster">Number-returning [ReQL](https://www.neurolib.io/pages/documentation) expression which allows you to boost recommendation rate of some items based on the values of their attributes.
        /// Boosters can be also assigned to a [scenario](https://www.neurolib.io/pages/documentation/scenarios.html) in the [Admin UI](https://admin.neurolib.io).
        /// </param>
