...
namespace Neurolib.ApiClient.ApiRequests
{
    ...
    /// <remarks>The properties (columns) must be previously created by Add item property(https://www.neurolib.io/pages/documentation/api.html#add-item-property).</remarks>
