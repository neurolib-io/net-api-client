...
namespace Neurolib.ApiClient
{
    /// <summary>Client for sending requests to Neurolib and getting replies</summary>
    public partial class NeurolibClient
    {
        ...
        readonly string hostUri = "api.neurolib.io";
        ...
        public NeurolibClient(string databaseId, string secretToken, bool useHttpsAsDefault = true,
                              string baseUri = null, int? port = null)
        {
            ...
            var envHostUri = Environment.GetEnvironmentVariable("NEUROLIB_API_URI");
            if(envHostUri != null)
        ...
        private HttpClient createHttpClient()
        {
            ...
            httpClient.DefaultRequestHeaders.Add("User-Agent", "neurolib-.net-api-client/3.2.0");
            return httpClient;
        }
